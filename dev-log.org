...
- checktype: 
  ...
  - server check the database info, checktype, add stu and teacher, and their number, into vector, teacher first.
...
- [-] 1.6 problem pushing
- [-] 1.7 answer problem
- [-] 1.8 student sign in & record
- [-] 1.9 attention check
- [-] 1.10 save record in file & show record
- [-] 1.11 ip address
- [X] 1.12
